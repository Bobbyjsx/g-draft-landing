...
export const CTA = () => {
  ...
  return (
    <section className="py-40 relative overflow-hidden flex flex-col items-center min-h-screen snap-start">
      {/* Subtle Bottom Glow */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <ScrollReveal className="max-w-3xl mx-auto">
          ...
          <p className="text-zinc-500 text-lg md:text-xl mb-14 leading-relaxed">
            Join the elite developers automating their Git lifecycle.{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button
              size="lg"
              className="w-full sm:w-auto h-16 px-10 text-lg bg-red-600 hover:bg-red-500 text-white border-none rounded-2xl shadow-[0_0_20px_rgba(239,68,68,0.2)]"
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="w-full h-16 px-10 text-lg border-white/10 hover:bg-white/5 rounded-2xl"
              >
          ...
          <div className="mt-16 flex items-center justify-center gap-8">
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold text-zinc-100">~13s</span>
